...
urls =
  todo: (todo) -> "http://127.0.0.1:#{todoPort}/todos/#{todo.id}"
  todos: -> "http://127.0.0.1:#{todoPort}/todos"
  markComplete: (todo) -> "http://127.0.0.1:#{todoPort}/todos/#{todo.id}/mark_complete"
  markActive: (todo) -> "http://127.0.0.1:#{todoPort}/todos/#{todo.id}/mark_active"
